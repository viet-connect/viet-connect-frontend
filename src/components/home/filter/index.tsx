...
import { searchKeyword, selectedRegionState } from '../../../recoil/atom/region';
...
export default function HomeFilter() {
  ...
  const [selectedProvince, setSelectedProvince] = useState(['defaultProvince', 'ALL']);
  ...
  const handleClickSetRegionArray = () => {
    ...
    setSelectedRegionState([region[selectedProvince[1]].province[0], selectedDistrict]);
    ...
    <Container>
        ...
        <SelectWrapper>
          <Select
            ...
            value={{
              ...
              label:
                selectedProvince[0] === 'defaultProvince' ? t(`jobTable:${selectedProvince[0]}`) : selectedProvince[0],
            }}
      ...
      <ButtonOutterWrapper className="home-button-wrapper">
        <CommonButton
          ...
          onClick={selectedProvince.length > 0 && selectedDistrict.length > 0 ? handleClickSetRegionArray : undefined}
        >
          <ButtonChildrenWrapper>
            <ButtonTextWrapper>{t('jobTable:searchBtnLabel')}</ButtonTextWrapper>
            <IconWrapper>
              <BsSearch style={{ verticalAlign: 'top' }} fontSize={13} color="white" />
            </IconWrapper>
          </ButtonChildrenWrapper>
        </CommonButton>
      </ButtonOutterWrapper>
