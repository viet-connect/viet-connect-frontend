export default Object.freeze({
	...
	CHUNGCHEONG_NORTH: {
		province: ['충청북도', 'CHUNGCHEONG_NORTH'],
		CHUNGCHEONG_NORTH: [
			'청주시 상당구',
			'청주시 서원구',
			'청주시 흥덕구',
	...
	CHUNGCHEONG_SOUTH: {
		province: ['충청남도', 'CHUNGCHEONG_SOUTH'],
		CHUNGCHEONG_SOUTH: [
			'천안시 동남구',
			'천안시 서북구',
			'공주시',
