const AppConfig = {
  ...
  additionalMetaTags: [
    {
      name: 'keywords',
      content: 'tìm việc làm tại hàn quốc, việc làm tại hàn quốc, giới thiệu việc làm tại Hàn Quốc, 외국인 알바',
    },
  ],
  additionalLinkTags: [
    {
  ...
  openGraph: {
    ...
    type: 'website',
    locale: 'ko_KR',
    title: '외국인 알바 찾을 땐? 비엣커넥트. Vietconnect giới thiệu việc làm tại Hàn Quốc miễn phí',
    site_name: '비엣커넥트',
    images: [
      {
