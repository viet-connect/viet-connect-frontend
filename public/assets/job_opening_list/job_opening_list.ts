...
export default [
	{
		...
		"title": "서울시 강동구 천호역 / TUYỂN NHÂN VIÊN CHẠY BÀN VÀ PHỤ BẾP Ở QUÁN ĂN (gần ga 천호, 5P ĐI BỘ, 군자 대한 곱창)",
    "tel": "010-2242-8129",
	...
	},
	{
		"id": 2,
		"category": constant.RESTAURANT,
		"title": "경기도 부천시 심곡동 gần ga 부천, 춘의 / TUYỂN NHÂN VIÊN PHỤ BẾP Ở QUÁN ĂN (목포명품등갈비 부천점)",
    "tel": "010-3246-5534",
    "gender": 2,  //성별 (0 - female, 1 - male, 2 - irrelevance)
    "korean_ability": 1, // 한국어능력(0, 1, 2, 3) 0이 아예 못하는것
    "salary_system": 3, // 급여방식(0 - monthly, 1 - weekly, 2 -  daily, 3 - hourly)
